...
const BUREAU_QUESTIONS = [
  "人材開発支援助成金 事業展開等リスキリング支援コース 定額制訓練 を申請したいのですが、書類の書き方がわからなくて。教えていただけますか？",
  "人材開発支援助成金 事業展開等リスキリング支援コース 定額制訓練 を申請したいのですが、どこに持っていけばいいですか？",
  "人材開発支援助成金 事業展開等リスキリング支援コース 定額制訓練 を申請したいのですが、講習とか書き方を教えてくれるような窓口はありますか？",
];
